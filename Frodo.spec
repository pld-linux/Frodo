...
Frodo jest darmowym, przenośnym emulatorem C64 dla BeOS, uniksów,
MacOS, AmigaOS, RiscOS i WinNT/Win9x.

Ten emulator skupia się na dokładnym odtworzeniu specjalnych efektów
graficznych osiągalnych na C64, więc ma dosyć duże wymagania dotyczące
systemu. Powinien być uruchamiany tylko na systemach z co najmniej
PowerPC/Pentium/68060. Frodo jest w stanie uruchomić poprawnie
większość gier i dem, nawet te z FLI, FLD, DYCP, otwartymi ramkami,
zamienianymi duszkami, dekoderami zależnymi od czasu, szybkimi
loaderami itp. Emulacja 6510: wszystkie nieudokumentowane instrukcje,
w pełni poprawny tryb dziesiętny, dokładna emulacja liczby cykli dla
instrukcji. Emulacja VIC: bazująca na liniach lub cyklach, wszystkie
tryby wyświetlania, duszki z kolizjami i priorytetami, cykle DMA,
otwarte ramki, wszystkie efekty $d011/$d016. Emulacja SID: emulacja
cyfrowa w czasie rzeczywistym (16 bitów. 44.1kHz), włącznie z filtrami
...
.t64/LYNX, lub emulacja 1541 na poziomie procesora, obsługująca około
95%% wszystkich szybkich loaderów i nawet niektóre rodzaje
zabezpieczeń przed kopiowaniem. Inne peryferia: klawiatura i joystick
(prawdziwe joysticki (tylko pod BeOS-em, Linuksem i AmigaOS-em) lub
emulacja na klawiaturze). Dostępne są pełne źródła w C++. Frodo jest
freeware.
